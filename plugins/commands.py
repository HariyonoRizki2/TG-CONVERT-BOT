...
developer = "https://t.me/{}".format(Config.USER_NAME[1:])
support_bot = "https://telegram.dog/kitgbotzsupport_bot"
...
async def start(c, m):
    ...
    await c.send_message(chat_id=m.chat.id,
                         ...
                         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url=developer), InlineKeyboardButton("Layanan Bantuan", url=support_bot)]]))
